# send bulk message async

This example sends bulk sms message asynchronously.
...
This module contains the function test_send_bulk_message_async:

```rust
use africastalking_rust::AfricasTalking;
use africastalking_rust::models::models::BulkSmsMessage;
...
pub async fn test_send_bulk_message_async(
    ...
    if let Ok(africas_talking) = _result {
        ...
        let _from = None; // optional parameter
