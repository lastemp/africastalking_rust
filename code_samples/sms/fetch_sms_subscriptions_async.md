# fetch sms subscriptions async

This example fetches premium sms subscriptions asynchronously.
...
This module contains the function test_fetch_sms_subscriptions_async:

```rust
use africastalking_rust::AfricasTalking;
use africastalking_rust::models::models::FetchSubscriptionsMessage;
...
pub async fn test_fetch_sms_subscriptions_async(
    ...
    if let Ok(africas_talking) = _result {
        ...
        let _keyword = String::from("***");
        let last_received_id = None; // optional parameter
