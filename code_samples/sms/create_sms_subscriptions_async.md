# create sms subscriptions async

This example creates premium sms subscriptions asynchronously.
...
This module contains the function test_create_sms_subscriptions_async:

```rust
use africastalking_rust::AfricasTalking;
use africastalking_rust::models::models::CreateSubscriptionsMessage;
