# fetch sms messages async

This example fetches sms messages asynchronously.
...
This module contains the function test_fetch_sms_messages_async:

```rust
use africastalking_rust::AfricasTalking;
use africastalking_rust::models::models::FetchSmsMessage;
